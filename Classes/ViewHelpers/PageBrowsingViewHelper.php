<?php
namespace InsanityMeetsHH\Base\ViewHelpers;
...
class PageBrowsingViewHelper extends \TYPO3\CMS\IndexedSearch\ViewHelpers\PageBrowsingViewHelper
{
    ...
    public static function renderStatic(array $arguments, \Closure $renderChildrenClosure, RenderingContextInterface $renderingContext)
    {
        ...
        for ($a = $minPage; $a <= $maxPage; $a++) {
            ...
            if ($a === $currentPage) {
                $content .= '<li class="page-item current"><strong>' . $label . '</strong></li>';
            } else {
    ...
    protected static function makecurrentPageSelector_link($str, $p, $freeIndexUid)
    {
        ...
        return '<a href="#" class="page-link bg-dark" onclick="' . htmlspecialchars($onclick) . '">' . $str . '</a>';
    }
}
